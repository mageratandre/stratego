...
func new_game():
	...
	possible_moves = gamelogic.compute_possible_moves(gamelogic.get_player(),dict_total)
...
func draw_all_pieces(dict) : 
	...
	for key in dict.keys():
		...
		spawner.create(dict[key][0],pos.x,pos.z,key,dict[key][1], dict[key][2])
...
func _on_game_logic_redraw(player: Variant, move: Variant, dict: Variant) -> void:
